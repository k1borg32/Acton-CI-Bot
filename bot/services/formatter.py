...
def format_start_message() -> str:
    ...
    return (
        ...
        "Free, public, open-source. I run CI checks for TON smart contracts "
        "directly from GitHub, GitLab, or Bitbucket repos — no setup needed.\n\n"
        "<b>What I run:</b>\n"
        ...
        "<b>Usage limits</b> (single VPS, keeping things fair):\n"
        "• 5 checks/hour and 30/day per user\n"
        "• 1 active check at a time\n"
        "• Max repo size: 50 MB\n"
        "• Public repositories only\n\n"
        "📚 /help — full reference\n"
        "💚 /donate — keep the bot running"
    )
...
def format_help_message() -> str:
    ...
    return (
        ...
        "• No network access, no Linux capabilities, no privilege escalation\n"
        "• Workspace auto-cleaned afterward\n\n"
        "<b>Open-source:</b>\n"
        "<a href=\"https://github.com/k1borg32/Acton-CI-Bot\">github.com/k1borg32/Acton-CI-Bot</a>\n"
        "Issues / PRs welcome. Bot is free; donations help cover the VPS."
    )
